...
import { Leaf, MapPin, Calendar, DollarSign, Search, Save, Trash2 } from "lucide-react"

// Mock request data - in real app this would be fetched based on ID
const mockRequest = {
  id: "1",
  ...
  priceType: "fixed",
  description:
    "Need fresh organic carrots for our restaurant. Looking for high quality produce with good color and texture.",
  neededBy: "2024-01-25",
  location: "123 Restaurant Street, Downtown, Nairobi",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Update your produce request information</p>
          </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {formData.priceType !== "donation" && (
                  <div className="space-y-2">
                    <Label htmlFor="maxPrice">Maximum Price per Unit (Ksh)</Label>
                    <Input
                      id="maxPrice"
                      type="number"
                      step="1"
